            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                  <?php
                    $qadmin = "SELECT id from admin";
                    $admin = $dbh->prepare($qadmin);
                    $admin->execute();
                    echo $admin->rowCount();
                  ?>
                  </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                  <?php
                    $qmobil = "SELECT id from kendaraan";
                    $mobil = $dbh->prepare($qmobil);
                    $mobil->execute();
                    echo $mobil->rowCount();
                  ?>
                  </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                  <?php
                    $qpesanan = "SELECT id_transaksi from transaksi";
                    $pesanan = $dbh->prepare($qpesanan);
                    $pesanan->execute();
                    echo $pesanan->rowCount();
                  ?>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                  <?php
                    $qusers = "SELECT id_user from users";
                    $users = $dbh->prepare($qusers);
                    $users->execute();
                    echo $users->rowCount();
                  ?>
                  </div>
